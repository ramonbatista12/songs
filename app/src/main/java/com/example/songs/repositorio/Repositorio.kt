...
class RepositorioService(val context: Context):InterfacePlylist {
...
@RequiresApi(Build.VERSION_CODES.Q)
   ...
   try {
    ...
    override suspend fun criarPlyList(nome: String) =interfassePlylist.criarPlyList(nome)
    override suspend fun criarPlaylist(nome: String, mediaItem: MediaItem)= interfassePlylist.criarPlaylist(nome,mediaItem)
    override suspend fun adicionarAplyList(idPlylist: Long, mediaItem: MediaItem) =interfassePlylist.adicionarAplyList(idPlylist,mediaItem)
    override suspend fun removerPlaylist(idPlylist: Long)=interfassePlylist.removerPlaylist(idPlylist)
    override suspend fun removerItemDaPlaylist(idPlylist: Long) = interfassePlylist.removerItemDaPlaylist(idPlylist)
    override fun listaPlaylist(): Flow<List<ListaPlaylist>> =interfassePlylist.listaPlaylist()
    override suspend fun mediaItemsDaPlylist(idPlylist: Long): Flow<List<ItemsDeMedia>> =interfassePlylist.mediaItemsDaPlylist(idPlylist)
